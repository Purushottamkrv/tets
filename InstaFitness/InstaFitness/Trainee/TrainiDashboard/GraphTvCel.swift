...
class GraphTvCel: UITableViewCell {

    @IBOutlet weak var piechart_view: UIView!
    var chartView:PieChart!
    override func awakeFromNib() {
        super.awakeFromNib()
        chartView = PieChart(frame: CGRect(x: 0, y: 0, width: piechart_view.frame.size.width, height: piechart_view.frame.size.height))
            piechart_view.addSubview(chartView)
